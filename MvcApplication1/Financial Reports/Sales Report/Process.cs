...
namespace MvcApplication1.Financial_Reports.Sales_Report
{
    ...
    public class Process
    {
        ...
        // constructor
        public Process(string _filePath)
        {
            filePath = _filePath;

            Log.Append("Process started for Sales Report...");

            fiscalYear = DateTime.Now.Year - 2000;

            // Adjust for fiscality
            if (DateTime.Now.Month >= 10) fiscalYear++;
